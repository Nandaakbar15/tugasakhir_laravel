...
Route::middleware(['web','auth', 'checkRole:admin'])->group(function() {
    ...
    Route::get('/service/status/{id}', 'App\Http\Controllers\StatusServisController@showStatus')->name('service.status'); // detail servis
    ...
    Route::put('/ubahGame/update/{game_request}', 'App\Http\Controllers\GameRequestController@update'); // logika ubah game
